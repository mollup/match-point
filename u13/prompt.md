You are implementing US{N} for MatchPoint.

INPUTS (read these first, in order):
1. user-stories.md — section US{N} (acceptance criteria are the contract)
2. u{N}/dev-spec.md — data model + endpoint shape
...
- UI changes need at least one Playwright/manual smoke step in u{N}/HumanTests.md.
